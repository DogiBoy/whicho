...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Which One");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseAuth.getCurrentUser()==null){
                    Intent loginInten = new Intent(MainActivity.this,RegisterActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Insta,InstaViewHolder> FBRA = new FirebaseRecyclerAdapter<Insta, InstaViewHolder>(
            ...
            protected void populateViewHolder(InstaViewHolder viewHolder, Insta model, int position) {
                ...
                viewHolder.setImage(getApplicationContext(),model.getImage(),model.getImage2());
    ...
    public static class InstaViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setImage(Context ctx, String image, String image2 ){
            ImageView post_image = (ImageView) itemView.findViewById(R.id.post_image);
            ImageView post_image2 = (ImageView) itemView.findViewById(R.id.post_image2);
            ImageLoader.getInstance().displayImage(image, post_image);
            ImageLoader.getInstance().displayImage(image2, post_image2);
        }
